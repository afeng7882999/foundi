...
-- ----------------------------
INSERT INTO `gen_table` VALUES ('1387749196181897218', 'sys_oper_log', '系统操作日志', '2021-02-28 00:05:18', 'InnoDB', 'utf8mb4_general_ci', 'OperLog', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '\0', '', '系统操作日志', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749196450332674', 'sys_role_menu', '系统角色与菜单对应关系', '2021-01-27 23:07:02', 'InnoDB', 'utf8mb4_general_ci', 'SysRoleMenu', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '\0', '系统角色与菜单对应关系', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749196517441538', 'sys_role_group', '系统角色与用户组对应关系', '2021-01-27 23:07:02', 'InnoDB', 'utf8mb4_general_ci', 'SysRoleGroup', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '\0', '系统角色与用户组对应关系', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749196601327617', 'sys_role', '系统角色', '2021-01-27 23:07:02', 'InnoDB', 'utf8mb4_general_ci', 'Role', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '', '系统角色', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749196689408001', 'sys_oauth_user', 'OAuth用户', '2021-01-27 23:07:02', 'InnoDB', 'utf8_general_ci', 'OauthUser', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '\0', 'OAuth用户', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749196739739649', 'sys_message_history', '系统消息历史', '2021-01-27 23:07:02', 'InnoDB', 'utf8mb4_general_ci', 'SysMessageHistory', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '\0', '系统消息历史', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749196802654210', 'sys_message', '系统消息', '2021-01-27 23:07:02', 'InnoDB', 'utf8mb4_general_ci', 'Message', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '\0', '系统消息', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749196886540289', 'sys_menu', '系统菜单', '2021-01-27 23:07:02', 'InnoDB', 'utf8mb4_general_ci', 'Menu', 'system', 'net.foundi.admin', null, '\0', '', 'id', 'name', 'parentId', 'sort', '', '\0', '系统菜单', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749196928483330', 'sys_user_role', '系统用户与角色对应关系', '2021-01-27 23:07:02', 'InnoDB', 'utf8mb4_general_ci', 'SysUserRole', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '\0', '系统用户与角色对应关系', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749197041729538', 'sys_user', '系统用户', '2021-01-27 23:07:02', 'InnoDB', 'utf8mb4_general_ci', 'User', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '', '系统用户', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749197100449793', 'sys_group', '系统用户组', '2021-01-27 23:07:01', 'InnoDB', 'utf8mb4_general_ci', 'SysGroup', 'system', 'net.foundi.admin', null, '\0', '', 'id', 'name', 'parentId', 'sort', '', '\0', '系统用户组', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749197171752961', 'sys_file', '文件上传', '2021-01-27 23:07:01', 'InnoDB', 'utf8mb4_general_ci', 'File', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '\0', '文件上传', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749197238861826', 'sys_dict', '系统字典', '2021-01-27 23:07:01', 'InnoDB', 'utf8mb4_bin', 'Dict', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '', '系统字典', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749197297582081', 'sys_config', '系统配置', '2021-01-27 23:07:01', 'InnoDB', 'utf8mb4_general_ci', 'Config', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '', '系统配置', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1387749197394051074', 'sys_login_log', '系统访问日志', '2021-01-27 23:07:01', 'InnoDB', 'utf8mb4_general_ci', 'LoginLog', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '\0', '', '系统访问日志', '20', 'admin');
INSERT INTO `gen_table` VALUES ('1392737836943290370', 'sys_task', '系统任务', '2021-01-27 23:07:02', 'InnoDB', 'utf8mb4_general_ci', 'Task', 'system', 'net.foundi.admin', null, '\0', '\0', null, null, null, null, '', '\0', '系统任务', '20', 'admin');
...
CREATE TABLE `gen_table_column` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1438173783532802050 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='代码生成业务表字段';

-- ----------------------------
-- Records of gen_table_column
-- ----------------------------
INSERT INTO `gen_table_column` VALUES ('1387749196085428225', 'sys_oper_log', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749196085428226', 'sys_oper_log', 'title', '模块标题', 'varchar', '', '', 'String', 'title', '\0', '\0', '\0', '', '', '', 'INNER_LIKE', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749196085428227', 'sys_oper_log', 'method', '方法名称', 'varchar', '', '', 'String', 'method', '\0', '\0', '\0', '', '', '\0', 'INNER_LIKE', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749196093816834', 'sys_oper_log', 'request_method', '请求方式', 'varchar', '', '', 'String', 'requestMethod', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '4');
INSERT INTO `gen_table_column` VALUES ('1387749196093816835', 'sys_oper_log', 'oper_user_id', '操作人员ID', 'bigint', '', '', 'Long', 'operUserId', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '5');
INSERT INTO `gen_table_column` VALUES ('1387749196093816836', 'sys_oper_log', 'oper_user_name', '操作人员账号名', 'varchar', '', '', 'String', 'operUserName', '\0', '\0', '\0', '', '', '\0', 'INNER_LIKE', 'input', '', '6');
INSERT INTO `gen_table_column` VALUES ('1387749196093816837', 'sys_oper_log', 'oper_user_roles', '操作人员角色', 'varchar', '', '', 'String', 'operUserRoles', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '7');
INSERT INTO `gen_table_column` VALUES ('1387749196093816838', 'sys_oper_log', 'group_name', '用户组名称', 'varchar', '', '', 'String', 'groupName', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '8');
INSERT INTO `gen_table_column` VALUES ('1387749196093816839', 'sys_oper_log', 'oper_url', '请求URL', 'varchar', '', '', 'String', 'operUrl', '\0', '\0', '\0', '', '\0', '', 'EQUAL', 'input', '', '9');
INSERT INTO `gen_table_column` VALUES ('1387749196102205442', 'sys_oper_log', 'oper_ip', '主机地址', 'varchar', '', '', 'String', 'operIp', '\0', '\0', '\0', '', '', '\0', 'INNER_LIKE', 'input', '', '10');
INSERT INTO `gen_table_column` VALUES ('1387749196102205443', 'sys_oper_log', 'oper_location', '操作地点', 'varchar', '', '', 'String', 'operLocation', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '11');
INSERT INTO `gen_table_column` VALUES ('1387749196102205444', 'sys_oper_log', 'oper_param', '请求参数', 'varchar', '', '', 'String', 'operParam', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '12');
INSERT INTO `gen_table_column` VALUES ('1387749196102205445', 'sys_oper_log', 'json_result', '返回参数', 'varchar', '', '', 'String', 'jsonResult', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '13');
INSERT INTO `gen_table_column` VALUES ('1387749196102205446', 'sys_oper_log', 'status_dict', '操作状态（字典：SysOperLogStatus，0：正常，1：异常）', 'varchar', '', '', 'String', 'statusDict', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', 'SysOperLogStatus', '14');
INSERT INTO `gen_table_column` VALUES ('1387749196102205447', 'sys_oper_log', 'error_msg', '错误消息', 'varchar', '', '', 'String', 'errorMsg', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '15');
INSERT INTO `gen_table_column` VALUES ('1387749196110594050', 'sys_oper_log', 'oper_time', '操作时间', 'datetime', '', '', 'Date', 'operTime', '\0', '\0', '\0', '', '', '\0', 'BETWEEN', 'daterange', '', '16');
INSERT INTO `gen_table_column` VALUES ('1387749196425166850', 'sys_role_menu', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749196433555458', 'sys_role_menu', 'role_id', '角色ID', 'bigint', '', '', 'Long', 'roleId', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749196433555459', 'sys_role_menu', 'menu_id', '菜单ID', 'bigint', '', '', 'Long', 'menuId', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749196483887105', 'sys_role_group', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749196492275714', 'sys_role_group', 'role_id', '角色ID', 'bigint', '', '', 'Long', 'roleId', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749196492275715', 'sys_role_group', 'group_id', '用户组ID', 'bigint', '', '', 'Long', 'groupId', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749196542607362', 'sys_role', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749196542607363', 'sys_role', 'name', '角色名称', 'varchar', 'UNI', '', 'String', 'name', '', '', '', '', '', '\0', 'EQUAL', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749196542607364', 'sys_role', 'label', '角色标识', 'varchar', '', '', 'String', 'label', '\0', '', '', '', '', '\0', 'EQUAL', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749196550995970', 'sys_role', 'remark', '备注', 'varchar', '', '', 'String', 'remark', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '4');
INSERT INTO `gen_table_column` VALUES ('1387749196550995971', 'sys_role', 'data_scope_dict', '数据范围（字典：SysRoleDataScope）', 'varchar', '', '', 'String', 'dataScopeDict', '\0', '', '', '', '', '\0', 'EQUAL', 'select', 'SysRoleDataScope', '5');
INSERT INTO `gen_table_column` VALUES ('1387749196550995972', 'sys_role', 'create_by', '创建用户id', 'bigint', '', '', 'Long', 'createBy', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '6');
INSERT INTO `gen_table_column` VALUES ('1387749196550995973', 'sys_role', 'create_at', '创建时间', 'datetime', '', '', 'Date', 'createAt', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '7');
INSERT INTO `gen_table_column` VALUES ('1387749196550995974', 'sys_role', 'update_by', '修改用户id', 'bigint', '', '', 'Long', 'updateBy', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '8');
INSERT INTO `gen_table_column` VALUES ('1387749196550995975', 'sys_role', 'update_at', '修改时间', 'datetime', '', '', 'Date', 'updateAt', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '9');
INSERT INTO `gen_table_column` VALUES ('1387749196550995976', 'sys_role', 'del_flag', '是否删除  1：已删除  0：正常', 'bit', '', '', 'Boolean', 'delFlag', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '10');
INSERT INTO `gen_table_column` VALUES ('1387749196634882050', 'sys_oauth_user', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749196634882051', 'sys_oauth_user', 'account', '账号', 'varchar', '', '', 'String', 'account', '', '', '', '', '', '\0', 'INNER_LIKE', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749196643270658', 'sys_oauth_user', 'nick_name', '昵称', 'varchar', '', '', 'String', 'nickName', '\0', '', '', '', '', '\0', 'INNER_LIKE', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749196643270659', 'sys_oauth_user', 'avatar', '头像', 'varchar', '', '', 'String', 'avatar', '\0', '', '', '', '\0', '\0', 'EQUAL', 'image', '', '4');
INSERT INTO `gen_table_column` VALUES ('1387749196643270660', 'sys_oauth_user', 'gender_dict', '性别（字典：Gender）', 'varchar', '', '', 'String', 'genderDict', '\0', '', '', '', '\0', '\0', 'EQUAL', 'select', 'Gender', '5');
INSERT INTO `gen_table_column` VALUES ('1387749196643270661', 'sys_oauth_user', 'open_id', 'OpenId', 'varchar', '', '', 'String', 'openId', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '6');
INSERT INTO `gen_table_column` VALUES ('1387749196643270663', 'sys_oauth_user', 'user_id', '关联user', 'bigint', '', '', 'Long', 'userId', '\0', '', '', '', '', '\0', 'EQUAL', 'input', '', '8');
INSERT INTO `gen_table_column` VALUES ('1387749196643270664', 'sys_oauth_user', 'create_at', '创建时间', 'datetime', '', '', 'Date', 'createAt', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '9');
INSERT INTO `gen_table_column` VALUES ('1387749196651659265', 'sys_oauth_user', 'update_at', '修改时间', 'datetime', '', '', 'Date', 'updateAt', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '10');
INSERT INTO `gen_table_column` VALUES ('1387749196710379522', 'sys_message_history', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749196718768130', 'sys_message_history', 'receiver_id', '接收方', 'bigint', '', '', 'Long', 'receiverId', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749196718768131', 'sys_message_history', 'message_id', '信息内容', 'bigint', '', '', 'Long', 'messageId', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749196718768132', 'sys_message_history', 'status_dict', '消息状态（字典：SysMessageStatus，未读、已读、删除)', 'varchar', '', '', 'String', 'statusDict', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '4');
INSERT INTO `gen_table_column` VALUES ('1387749196760711170', 'sys_message', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749196760711171', 'sys_message', 'title', '标题', 'varchar', '', '', 'String', 'title', '', '', '', '', '', '\0', 'INNER_LIKE', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749196760711172', 'sys_message', 'content', '信息内容', 'varchar', '', '', 'String', 'content', '', '', '', '', '\0', '\0', 'EQUAL', 'textarea', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749196769099778', 'sys_message', 'type_dict', '信息类型（字典：SysMessageType）', 'varchar', '', '', 'String', 'typeDict', '', '', '', '', '', '\0', 'IN', 'select', 'SysMessageType', '4');
INSERT INTO `gen_table_column` VALUES ('1387749196769099779', 'sys_message', 'sender_id', '发送方', 'bigint', '', '', 'Long', 'senderId', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '5');
INSERT INTO `gen_table_column` VALUES ('1387749196769099780', 'sys_message', 'is_group', '是否群发', 'bit', '', '', 'Boolean', 'isGroup', '\0', '', '', '', '\0', '\0', 'EQUAL', 'checkbox', '', '6');
INSERT INTO `gen_table_column` VALUES ('1387749196769099781', 'sys_message', 'group_id', '接收组', 'bigint', '', '', 'Long', 'groupId', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '7');
INSERT INTO `gen_table_column` VALUES ('1387749196769099782', 'sys_message', 'create_at', '发送时间', 'datetime', '', '', 'Date', 'createAt', '\0', '\0', '\0', '', '', '\0', 'BETWEEN', 'input', '', '8');
INSERT INTO `gen_table_column` VALUES ('1387749196827820033', 'sys_menu', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749196827820034', 'sys_menu', 'parent_id', '父菜单ID，一级菜单为0', 'bigint', '', '', 'Long', 'parentId', '\0', '', '', '', '', '\0', 'EQUAL', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749196827820035', 'sys_menu', 'name', '菜单名称', 'varchar', '', '', 'String', 'name', '', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749196827820036', 'sys_menu', 'url', '菜单URL', 'varchar', '', '', 'String', 'url', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '4');
INSERT INTO `gen_table_column` VALUES ('1387749196827820037', 'sys_menu', 'redirect', '菜单跳转', 'varchar', '', '', 'String', 'redirect', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '5');
INSERT INTO `gen_table_column` VALUES ('1387749196827820038', 'sys_menu', 'perms', '授权（多个用逗号分隔，如：user:list,user:create）', 'varchar', '', '', 'String', 'perms', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '6');
INSERT INTO `gen_table_column` VALUES ('1387749196827820039', 'sys_menu', 'type_dict', '类型（字典：SysMenuType，0：目录，1：菜单，2：按钮）', 'varchar', '', '', 'String', 'typeDict', '', '', '', '', '\0', '\0', 'EQUAL', 'select', 'SysMenuType', '7');
INSERT INTO `gen_table_column` VALUES ('1387749196836208642', 'sys_menu', 'icon', '菜单图标', 'varchar', '', '', 'String', 'icon', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '8');
INSERT INTO `gen_table_column` VALUES ('1387749196836208643', 'sys_menu', 'abbr', '菜单缩写', 'varchar', '', '', 'String', 'abbr', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '9');
INSERT INTO `gen_table_column` VALUES ('1387749196836208644', 'sys_menu', 'sort', '排序', 'int', '', '', 'Integer', 'sort', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '10');
INSERT INTO `gen_table_column` VALUES ('1387749196836208645', 'sys_menu', 'remark', '注释', 'varchar', '', '', 'String', 'remark', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '11');
INSERT INTO `gen_table_column` VALUES ('1387749196840402945', 'sys_menu', 'visible', '是否显示', 'bit', '', '', 'Boolean', 'visible', '\0', '', '', '', '\0', '\0', 'EQUAL', 'checkbox', '', '12');
INSERT INTO `gen_table_column` VALUES ('1387749196840402946', 'sys_menu', 'create_at', '创建时间', 'datetime', '', '', 'Date', 'createAt', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '13');
INSERT INTO `gen_table_column` VALUES ('1387749196840402947', 'sys_menu', 'update_at', '修改时间', 'datetime', '', '', 'Date', 'updateAt', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '14');
INSERT INTO `gen_table_column` VALUES ('1387749196911706114', 'sys_user_role', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749196911706115', 'sys_user_role', 'user_id', '用户ID', 'bigint', '', '', 'Long', 'userId', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749196911706116', 'sys_user_role', 'role_id', '角色ID', 'bigint', '', '', 'Long', 'roleId', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749196953649153', 'sys_user', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749196953649154', 'sys_user', 'username', '用户名', 'varchar', 'UNI', '', 'String', 'username', '', '', '', '', '', '\0', 'INNER_LIKE', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749196953649155', 'sys_user', 'password', '密码', 'varchar', '', '', 'String', 'password', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749196962037762', 'sys_user', 'mobile', '手机号', 'varchar', 'UNI', '', 'String', 'mobile', '', '', '', '', '', '\0', 'INNER_LIKE', 'input', '', '4');
INSERT INTO `gen_table_column` VALUES ('1387749196962037763', 'sys_user', 'group_id', '用户组', 'bigint', '', '', 'Long', 'groupId', '\0', '', '', '', '', '\0', 'IN', 'input', '', '5');
INSERT INTO `gen_table_column` VALUES ('1387749196962037764', 'sys_user', 'name', '姓名', 'varchar', '', '', 'String', 'name', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '6');
INSERT INTO `gen_table_column` VALUES ('1387749196962037765', 'sys_user', 'avatar', '头像', 'varchar', '', '', 'String', 'avatar', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '7');
INSERT INTO `gen_table_column` VALUES ('1387749196962037766', 'sys_user', 'status_dict', '状态（字典：SysUserStatus，0：正常，1：禁用）', 'varchar', '', '', 'String', 'statusDict', '\0', '', '', '', '', '\0', 'EQUAL', 'select', 'SysUserStatus', '8');
INSERT INTO `gen_table_column` VALUES ('1387749196962037767', 'sys_user', 'email', '邮箱', 'varchar', 'UNI', '', 'String', 'email', '', '', '', '', '', '\0', 'EQUAL', 'input', '', '9');
INSERT INTO `gen_table_column` VALUES ('1387749196962037768', 'sys_user', 'gender_dict', '性别（字典：Gender，0：未知，1：男，2：女）', 'varchar', '', '', 'String', 'genderDict', '\0', '', '', '', '\0', '\0', 'EQUAL', 'select', 'Gender', '10');
INSERT INTO `gen_table_column` VALUES ('1387749196962037769', 'sys_user', 'birthday', '出生日期', 'datetime', '', '', 'Date', 'birthday', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '11');
INSERT INTO `gen_table_column` VALUES ('1387749196962037770', 'sys_user', 'address', '住址', 'varchar', '', '', 'String', 'address', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '12');
INSERT INTO `gen_table_column` VALUES ('1387749196970426369', 'sys_user', 'province', '省份', 'varchar', '', '', 'String', 'province', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '13');
INSERT INTO `gen_table_column` VALUES ('1387749196970426370', 'sys_user', 'city', '所在城市', 'varchar', '', '', 'String', 'city', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '14');
INSERT INTO `gen_table_column` VALUES ('1387749196970426371', 'sys_user', 'district', '所在地区', 'varchar', '', '', 'String', 'district', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '15');
INSERT INTO `gen_table_column` VALUES ('1387749196970426372', 'sys_user', 'create_at', '创建时间', 'datetime', '', '', 'Date', 'createAt', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '16');
INSERT INTO `gen_table_column` VALUES ('1387749196970426373', 'sys_user', 'create_by', '创建者id', 'bigint', '', '', 'Long', 'createBy', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '17');
INSERT INTO `gen_table_column` VALUES ('1387749196970426374', 'sys_user', 'update_by', '修改者id', 'bigint', '', '', 'Long', 'updateBy', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '18');
INSERT INTO `gen_table_column` VALUES ('1387749196970426375', 'sys_user', 'update_at', '修改时间', 'datetime', '', '', 'Date', 'updateAt', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '19');
INSERT INTO `gen_table_column` VALUES ('1387749197066895362', 'sys_group', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749197066895363', 'sys_group', 'parent_id', '上级用户组ID，一级用户组为0', 'bigint', '', '', 'Long', 'parentId', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749197066895364', 'sys_group', 'sort', '排序', 'int', '', '', 'Integer', 'sort', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749197066895365', 'sys_group', 'name', '用户组名称', 'varchar', '', '', 'String', 'name', '', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '4');
INSERT INTO `gen_table_column` VALUES ('1387749197066895366', 'sys_group', 'del_flag', '是否删除  1：已删除  0：正常', 'bit', '', '', 'Boolean', 'delFlag', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '5');
INSERT INTO `gen_table_column` VALUES ('1387749197125615618', 'sys_file', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749197125615619', 'sys_file', 'name', '文件名', 'varchar', '', '', 'String', 'name', '\0', '', '', '', '', '\0', 'INNER_LIKE', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749197125615620', 'sys_file', 'oss', '文件上传的OSS配置键值', 'varchar', '', '', 'String', 'oss', '\0', '', '', '', '', '\0', 'EQUAL', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749197125615621', 'sys_file', 'type_dict', '文件类型（字典：SysFileType）', 'varchar', '', '', 'String', 'typeDict', '\0', '', '', '', '', '\0', 'EQUAL', 'select', 'SysFileType', '4');
INSERT INTO `gen_table_column` VALUES ('1387749197134004226', 'sys_file', 'url', 'URL地址', 'varchar', '', '', 'String', 'url', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '5');
INSERT INTO `gen_table_column` VALUES ('1387749197134004227', 'sys_file', 'create_by', '创建人', 'bigint', '', '', 'Long', 'createBy', '\0', '\0', '\0', '', '', '\0', 'EQUAL', 'input', '', '6');
INSERT INTO `gen_table_column` VALUES ('1387749197134004228', 'sys_file', 'create_at', '创建时间', 'datetime', '', '', 'Date', 'createAt', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '7');
INSERT INTO `gen_table_column` VALUES ('1387749197192724482', 'sys_dict', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749197196918785', 'sys_dict', 'name', '字典名', 'varchar', '', '', 'String', 'name', '', '', '', '', '', '\0', 'INNER_LIKE', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1387749197196918786', 'sys_dict', 'name_cn', '字典中文名', 'varchar', '', '', 'String', 'nameCn', '\0', '', '', '', '', '\0', 'INNER_LIKE', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749197196918787', 'sys_dict', 'remarks', '备注信息', 'varchar', '', '', 'String', 'remarks', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '4');
INSERT INTO `gen_table_column` VALUES ('1387749197196918788', 'sys_dict', 'create_by', '创建者', 'bigint', '', '', 'Long', 'createBy', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '5');
INSERT INTO `gen_table_column` VALUES ('1387749197196918789', 'sys_dict', 'create_at', '创建时间', 'datetime', '', '', 'Date', 'createAt', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '6');
INSERT INTO `gen_table_column` VALUES ('1387749197196918790', 'sys_dict', 'update_by', '更新者', 'bigint', '', '', 'Long', 'updateBy', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '7');
INSERT INTO `gen_table_column` VALUES ('1387749197196918791', 'sys_dict', 'update_at', '更新时间', 'datetime', '', '', 'Date', 'updateAt', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '8');
INSERT INTO `gen_table_column` VALUES ('1387749197196918792', 'sys_dict', 'del_flag', '是否删除  1：已删除  0：正常', 'bit', '', '', 'Boolean', 'delFlag', '\0', '\0', '\0', '\0', '\0', '\0', 'EQUAL', 'input', '', '9');
INSERT INTO `gen_table_column` VALUES ('1387749197264027649', 'sys_config', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749197264027650', 'sys_config', 'config_type_dict', '配置分类（字典：SysConfigType)', 'varchar', '', '', 'String', 'configTypeDict', '\0', '', '', '', '', '\0', 'IN', 'select', 'SysConfigType', '2');
INSERT INTO `gen_table_column` VALUES ('1387749197264027651', 'sys_config', 'config_key', '键', 'varchar', '', '', 'String', 'configKey', '', '', '', '', '', '\0', 'INNER_LIKE', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1387749197264027652', 'sys_config', 'config_value', '值', 'varchar', '', '', 'String', 'configValue', '', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '4');
INSERT INTO `gen_table_column` VALUES ('1387749197264027653', 'sys_config', 'enabled', '是否启用', 'bit', '', '', 'Boolean', 'enabled', '\0', '', '', '', '', '\0', 'EQUAL', 'checkbox', '', '5');
INSERT INTO `gen_table_column` VALUES ('1387749197264027654', 'sys_config', 'remark', '备注', 'varchar', '', '', 'String', 'remark', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '6');
INSERT INTO `gen_table_column` VALUES ('1387749197272416258', 'sys_config', 'create_at', '创建时间', 'datetime', '', '', 'Date', 'createAt', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '7');
INSERT INTO `gen_table_column` VALUES ('1387749197343719426', 'sys_login_log', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1387749197343719427', 'sys_login_log', 'type_dict', '类型（字典：SysLoginLogType，0：login，1：logout）', 'varchar', '', '', 'String', 'typeDict', '\0', '', '', '', '', '\0', 'IN', 'select', 'SysLoginLogType', '3');
INSERT INTO `gen_table_column` VALUES ('1387749197343719428', 'sys_login_log', 'user_name', '用户账号', 'varchar', '', '', 'String', 'userName', '\0', '', '', '', '', '\0', 'INNER_LIKE', 'input', '', '5');
INSERT INTO `gen_table_column` VALUES ('1387749197343719429', 'sys_login_log', 'ip', '登录IP地址', 'varchar', '', '', 'String', 'ip', '\0', '', '', '', '', '\0', 'INNER_LIKE', 'input', '', '6');
INSERT INTO `gen_table_column` VALUES ('1387749197343719430', 'sys_login_log', 'location', '登录地点', 'varchar', '', '', 'String', 'location', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '7');
INSERT INTO `gen_table_column` VALUES ('1387749197352108034', 'sys_login_log', 'browser', '浏览器类型', 'varchar', '', '', 'String', 'browser', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '8');
INSERT INTO `gen_table_column` VALUES ('1387749197352108035', 'sys_login_log', 'os', '操作系统', 'varchar', '', '', 'String', 'os', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '9');
INSERT INTO `gen_table_column` VALUES ('1387749197352108036', 'sys_login_log', 'authc_type_dict', '登录方式', 'varchar', '', '', 'String', 'authcTypeDict', '\0', '', '', '', '', '\0', 'IN', 'select', 'SysAuthcType', '4');
INSERT INTO `gen_table_column` VALUES ('1387749197352108037', 'sys_login_log', 'status_dict', '登录状态（字典：SysLoginLogStatus，0：成功，1：失败）', 'varchar', '', '', 'String', 'statusDict', '\0', '', '', '', '', '\0', 'EQUAL', 'select', 'SysLoginLogStatus', '10');
INSERT INTO `gen_table_column` VALUES ('1387749197352108038', 'sys_login_log', 'message', '提示消息', 'varchar', '', '', 'String', 'message', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '11');
INSERT INTO `gen_table_column` VALUES ('1387749197352108039', 'sys_login_log', 'oper_time', '登录、登出时间', 'datetime', '', '', 'Date', 'operTime', '\0', '', '', '', '', '\0', 'BETWEEN', 'daterange', '', '2');
INSERT INTO `gen_table_column` VALUES ('1392737836842627074', 'sys_task', 'id', '主键', 'bigint', 'PRI', '', 'Long', 'id', '', '\0', '\0', '\0', '\0', '\0', 'EQUAL', '', '', '1');
INSERT INTO `gen_table_column` VALUES ('1392737836851015682', 'sys_task', 'job_name', '任务名', 'varchar', '', '', 'String', 'jobName', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '2');
INSERT INTO `gen_table_column` VALUES ('1392737836855209985', 'sys_task', 'job_group', '任务分组', 'varchar', '', '', 'String', 'jobGroup', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '3');
INSERT INTO `gen_table_column` VALUES ('1392737836855209986', 'sys_task', 'job_status', '任务状态', 'varchar', '', '', 'String', 'jobStatus', '\0', '', '', '', '\0', '\0', 'EQUAL', 'checkbox', '', '4');
INSERT INTO `gen_table_column` VALUES ('1392737836855209987', 'sys_task', 'is_concurrent', '任务是否并发', 'bit', '', '', 'Boolean', 'isConcurrent', '\0', '', '', '', '\0', '\0', 'EQUAL', 'checkbox', '', '5');
INSERT INTO `gen_table_column` VALUES ('1392737836855209988', 'sys_task', 'cron_expression', 'cron表达式', 'varchar', '', '', 'String', 'cronExpression', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '6');
INSERT INTO `gen_table_column` VALUES ('1392737836855209989', 'sys_task', 'description', '任务描述', 'varchar', '', '', 'String', 'description', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '7');
INSERT INTO `gen_table_column` VALUES ('1392737836855209990', 'sys_task', 'bean_class', '任务执行时调用哪个类的方法 包名+类名', 'varchar', '', '', 'String', 'beanClass', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '8');
INSERT INTO `gen_table_column` VALUES ('1392737836863598594', 'sys_task', 'spring_bean', 'Spring bean', 'varchar', '', '', 'String', 'springBean', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '9');
INSERT INTO `gen_table_column` VALUES ('1392737836863598595', 'sys_task', 'method_name', '任务调用的方法名', 'varchar', '', '', 'String', 'methodName', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '10');
INSERT INTO `gen_table_column` VALUES ('1392737836863598596', 'sys_task', 'create_at', '创建时间', 'datetime', '', '', 'Date', 'createAt', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '11');
INSERT INTO `gen_table_column` VALUES ('1392737836863598597', 'sys_task', 'create_by', '创建者', 'bigint', '', '', 'Long', 'createBy', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '12');
INSERT INTO `gen_table_column` VALUES ('1392737836867792897', 'sys_task', 'update_at', '更新时间', 'datetime', '', '', 'Date', 'updateAt', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '13');
INSERT INTO `gen_table_column` VALUES ('1392737836867792898', 'sys_task', 'update_by', '更新者', 'bigint', '', '', 'Long', 'updateBy', '\0', '\0', '\0', '', '\0', '\0', 'EQUAL', 'input', '', '14');
INSERT INTO `gen_table_column` VALUES ('1438173783532802049', 'sys_oauth_user', 'oauth_type_dict', '认证类型（字典：SysOauthType）', 'varchar', '', '', 'String', 'oauthTypeDict', '\0', '', '', '', '\0', '\0', 'EQUAL', 'input', '', '7');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '超级管理员', 'super_admin', '超级管理员', '0', '1', '2020-11-19 14:11:55', '1', '2022-01-03 15:11:08', '\0');
...
INSERT INTO `sys_role_group` VALUES ('1477900317835133008', '1', '10');
INSERT INTO `sys_role_group` VALUES ('1477900317835133009', '1', '20');
INSERT INTO `sys_role_group` VALUES ('1477900317835133010', '1', '30');
INSERT INTO `sys_role_group` VALUES ('1477900317835133011', '1', '1419183541404688386');
...
INSERT INTO `sys_role_menu` VALUES ('1477900317835132929', '1', '10');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132930', '1', '11');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132931', '1', '20');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132932', '1', '1330895557467602946');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132933', '1', '1330895557467602947');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132934', '1', '1330895557467602948');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132935', '1', '1330895557467602949');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132936', '1', '1330895557467602950');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132937', '1', '1330898330087112706');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132938', '1', '1330898330087112707');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132939', '1', '1330898330087112708');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132940', '1', '1330898330087112709');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132941', '1', '1330898330087112710');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132942', '1', '1330898330930167809');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132943', '1', '1330898330930167810');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132944', '1', '1330898330930167811');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132945', '1', '1330898330930167812');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132946', '1', '1330898330930167813');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132947', '1', '1330898329399246850');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132948', '1', '1330898329399246851');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132949', '1', '1330898329399246852');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132950', '1', '1330898329399246853');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132951', '1', '1330898329399246854');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132952', '1', '1423791489158344706');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132953', '1', '1423791489158344707');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132954', '1', '1423791489158344708');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132955', '1', '1423791489158344709');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132956', '1', '1423791489158344710');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132957', '1', '1330898331173437442');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132958', '1', '1330898331173437443');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132959', '1', '1330898331173437444');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132960', '1', '1330898331173437445');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132961', '1', '1330898331173437446');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132962', '1', '1330898329785122817');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132963', '1', '1330898329785122818');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132964', '1', '1330898329785122819');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132965', '1', '1330898329785122820');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132966', '1', '1330898329785122821');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132967', '1', '1330898330233913345');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132968', '1', '1330898330233913346');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132969', '1', '1330898330233913348');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132970', '1', '1330898330233913349');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132971', '1', '1330898330233913347');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132972', '1', '1390339339984146433');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132973', '1', '1390339339984146434');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132974', '1', '1390339339984146435');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132975', '1', '1390339339984146436');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132976', '1', '1390339339984146437');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132977', '1', '1330898331462844418');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132978', '1', '1330898331462844419');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132979', '1', '1330898331462844420');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132980', '1', '1330898331462844421');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132981', '1', '1330898331462844422');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132982', '1', '1330898330678509570');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132983', '1', '1330898330678509571');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132984', '1', '1330898330678509572');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132985', '1', '1330898330678509573');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132986', '1', '1330898330678509574');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132987', '1', '1330898330795950081');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132988', '1', '1330898330795950082');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132989', '1', '1330898330795950083');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132990', '1', '1330898330795950084');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132991', '1', '1330898330795950085');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132992', '1', '1388163373723598849');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132993', '1', '1388163373723598850');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132994', '1', '1388163373723598851');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132995', '1', '1388163373723598852');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132996', '1', '1388163373723598853');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132997', '1', '30');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132998', '1', '1364834446406103042');
INSERT INTO `sys_role_menu` VALUES ('1477900317835132999', '1', '1364834446406103043');
INSERT INTO `sys_role_menu` VALUES ('1477900317835133000', '1', '1364834446406103044');
INSERT INTO `sys_role_menu` VALUES ('1477900317835133001', '1', '1364834446406103045');
INSERT INTO `sys_role_menu` VALUES ('1477900317835133002', '1', '1364834446406103046');
INSERT INTO `sys_role_menu` VALUES ('1477900317835133003', '1', '40');
INSERT INTO `sys_role_menu` VALUES ('1477900317835133004', '1', '1469200281613914114');
INSERT INTO `sys_role_menu` VALUES ('1477900317835133005', '1', '100');
INSERT INTO `sys_role_menu` VALUES ('1477900317835133006', '1', '1477483348354924546');
INSERT INTO `sys_role_menu` VALUES ('1477900317835133007', '1', '1477900255235145729');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '$2a$10$iBNeuqPrTagJmSXUGD1zqe31a7N48acZk02jQKnmrG6FUstbqFtGO', '13903271895', '20', 'Foundi Admin', '/upload/20220103/ali-pazani-RNHujsmCOqo-unsplash_fd966657.png', '0', 'afeng7882999@163.com', '1', '2021-01-12 00:00:00', '创客基地', '宁夏回族自治区', '吴忠市', '利通区', '2017-08-15 21:40:39', '1', '1', '2022-01-03 00:25:18');
